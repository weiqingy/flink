...
- **FLINK-38477 — FINISHED watermark status** ([FLINK-38477](https://issues.apache.org/jira/browse/FLINK-38477) · [PR 27083](https://github.com/apache/flink/pull/27083)): under community review, with a **community request to expand it into a FLIP**.
...
**Apache Auron (incubating) — committer since 2026-08-07** ([ANNOUNCE](https://lists.apache.org/thread/okybwtrf7nt62hv6y99c8v8rg2tsvll5) · roster: ASF availid `weiqing` in the [Auron committer group](https://people.apache.org/phonebook.html?ppmc=auron)). First ASF committership; not on the PPMC. Basis: Flink integration 0→1 (§2, §4), 35 reviews on others' PRs, and dev@auron release/design votes (§5).

Contributor across **7 other Apache projects**: Spark, Samza, Ambari, HBase, Hadoop, Livy, Auron (incubating), in addition to Flink & flink-agents. **No Flink committer/PMC role yet.**
